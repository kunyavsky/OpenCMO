export const en = {
  ...
  "landing.metaTitle": "OpenCMO | AI CMO Workspace for Search, AI Visibility, and Growth Operations",
  "landing.metaDescription": "OpenCMO is an open-source AI CMO workspace that connects SEO audits, GEO visibility, SERP tracking, community monitoring, and growth execution.",
  ...
  "landing.heroTitle": "See how your brand is discovered, interpreted, and talked about.",
  "landing.heroSubtitle": "OpenCMO gives growth teams one workspace for SEO, GEO, SERP, community signals, and the execution layer that turns those signals into actions.",
  "landing.badge": "Built for search engines, AI crawlers, and growth teams",
  ...
  "landing.crawlerBody": "The public site now exposes the technical signals that search engines and AI agents need: a canonical homepage, robots rules, a sitemap, and an llms.txt summary for machine-readable context.",
  ...
  "landing.capabilitiesSubtitle": "This is not just another dashboard. It combines technical visibility checks, AI mention tracking, and execution workflows in one place.",
  ...
  "blog.metaTitle": "OpenCMO Blog | Notes on SEO, GEO, AI Visibility, and Growth Operations",
  "blog.metaDescription": "Read OpenCMO's public notes on AI CMO workflows, crawler-readable sites, GEO strategy, SEO operations, and community-aware growth.",
  "blog.eyebrow": "OpenCMO Journal",
  "blog.title": "Essays on visibility, systems, and how modern brands are actually discovered.",
  "blog.subtitle": "The OpenCMO blog is where the product gets explained in public: the philosophy behind the workspace, the operator logic behind each module, and the technical choices that make the site readable to both people and machines.",
  "blog.editorNote": "These notes are written for founders, growth teams, and curious operators who are tired of fragmented marketing tools and want a more coherent visibility system.",
  ...
  "blog.librarySubtitle": "Four editorial notes that explain the product, the worldview behind it, and the modules that make the system work.",
