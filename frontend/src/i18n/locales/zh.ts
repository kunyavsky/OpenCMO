...
export const zh: Record<TranslationKey, string> = {
  ...
  "landing.metaTitle": "OpenCMO | 面向搜索、AI 可见度与增长运营的 AI CMO 工作台",
  "landing.metaDescription": "OpenCMO 是一个开源 AI CMO 工作台，把 SEO 审计、GEO 可见度、SERP 跟踪、社区监控与增长执行连接在一起。",
  "landing.navPlatform": "产品",
  "landing.navWorkflow": "工作流",
  "landing.navBlog": "Blog",
  "landing.navFaq": "FAQ",
  "landing.heroEyebrow": "开源可见度操作系统",
  "landing.heroTitle": "看清你的品牌是如何被发现、被理解、被讨论的。",
  "landing.heroSubtitle": "OpenCMO 把 SEO、GEO、SERP、社区信号，以及把这些信号转成动作的执行层，放进同一个增长工作台。",
  "landing.badge": "为搜索引擎、AI 爬虫与增长团队而建",
  ...
  "landing.crawlerBody": "现在公开站点已经补齐搜索引擎和 AI agent 需要的关键技术信号：规范首页、robots 规则、sitemap，以及用于机器理解的 llms.txt 摘要。",
  ...
  "landing.capabilitiesSubtitle": "它不只是一个仪表盘，而是把技术可见度检查、AI 提及追踪和执行工作流放到一个地方。",
  ...
  "blog.metaTitle": "OpenCMO Blog | SEO、GEO、AI 可见度与增长运营笔记",
  "blog.metaDescription": "阅读 OpenCMO 关于 AI CMO 工作流、站点机器可读性、GEO 策略、SEO 运营与社区驱动增长的公开笔记。",
  "blog.eyebrow": "OpenCMO Journal",
  "blog.title": "关于可见度、系统，以及现代品牌究竟如何被发现的一组长文。",
  "blog.subtitle": "OpenCMO 的 blog 不只是产品说明页，而是公开解释这套系统的地方：为什么工作台要这样设计、每个模块解决什么问题、以及为什么“被读懂”本身已经是分发的一部分。",
  "blog.editorNote": "这些文章写给创始人、增长团队和一线操盘手。它们不卖弄术语，而是持续回答一个问题：当 Google、AI 助手、社区讨论和你的网站共同塑造品牌认知时，团队该如何形成一致判断并真正执行。",
  "blog.homeCta": "返回首页",
  "blog.workspaceCta": "打开工作台",
  "blog.featuredLabel": "从精选文章开始",
  "blog.libraryTitle": "内容库",
  "blog.librarySubtitle": "四篇专题文章，分别讲清楚 OpenCMO 的产品思想、操作逻辑、公开可读性，以及工作台内部到底有哪些能力。",
