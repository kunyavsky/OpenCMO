...
export const zh: Record<TranslationKey, string> = {
  ...
  // GitHub Leads
  "project.githubLeads": "GitHub 线索",
  "github.totalLeads": "总线索",
  "github.enriched": "已充实",
  "github.hasEmail": "有邮箱",
  "github.hasTwitter": "有 Twitter",
  "github.avgScore": "平均评分",
  "github.autoMode": "自动发现",
  "github.autoModeDesc": "线索会在扫描时根据产品关键词和竞品自动发现。仅展示有联系方式的用户。",
  "github.rescore": "重新评分",
  ...
  "github.noLeads": "暂无 GitHub 线索",
  "github.noLeadsDesc": "扫描运行后线索会自动出现。请确保项目已配置关键词和竞品。",
  "github.languages": "语言",
  "github.stars": "Star 数",
  "github.score": "评分",
  "github.selected": "已选中",
